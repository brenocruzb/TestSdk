package br.com.paggcerto.paggcertosdk.Communication

import android.util.Log
import br.com.paggcerto.paggcertosdk.Util.Util
import br.com.paggcerto.paggcertosdk.Util.Util.errorTimeOut
        ...
        return try{
            ...
            do {
                ...
                if(response == errorTimeOut){
                    if(CommandReader.forceBreak){
                        CommandReader.forceBreak = false
